...
import { Brain, Send, Lightbulb, MessageCircle, Sparkles } from 'lucide-react';
import { generateAIResponse } from '../utils/aiChatResponses';
import { AIMessage, Todo } from '../types';
...
export const AIAssistant: React.FC<AIAssistantProps> = ({ todos, className = '' }) => {
